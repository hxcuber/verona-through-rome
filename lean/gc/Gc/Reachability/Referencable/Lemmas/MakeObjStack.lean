...
theorem makeObjStack_corollary_loc_eq_of_ne_fresh {cfg cfg' : RuntimeConfig} {x : VarName}
...
theorem makeObjStack_corollary_objAt_eq_of_ne_fresh (vcfg : ValidConfig cfg) (vcfg' : ValidConfig cfg')
    {oid : ObjectId} (h : makeObjStack x cfg = some cfg') (hne : oid ≠ cfg.freshObjectId) :
...
theorem makeObjStack_corollary_loc_fresh {cfg cfg' : RuntimeConfig} {x : VarName}
...
-- edges at all in cfg'.
theorem makeObjStack_corollary_objAt_fresh {cfg cfg' : RuntimeConfig} {x : VarName}
    (h : makeObjStack x cfg = some cfg') :
...
theorem makeObjStack_corollary_refStep_iff (vcfg : ValidConfig cfg) (vcfg' : ValidConfig cfg')
    (h : makeObjStack x cfg = some cfg') :
...
theorem makeObjStack_corollary_refStep_source_ne_fresh_cfg' {cfg cfg' : RuntimeConfig} {x : VarName}
...
theorem makeObjStack_corollary_frameRoot_down {cfg cfg' : RuntimeConfig} {x : VarName}
    (h : makeObjStack x cfg = some cfg')
