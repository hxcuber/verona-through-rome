...
theorem merge_corollary_objectIds_perm (vcfg : ValidConfig cfg) {x : VarName} {cfg' : RuntimeConfig}
...
theorem merge_corollary_objAt_eq (vcfg : ValidConfig cfg) {x : VarName} {cfg' : RuntimeConfig}
...
theorem merge_corollary_frameRoot_down (vcfg' : ValidConfig cfg')
