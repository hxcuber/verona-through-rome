...
theorem makeRegion_corollary_mem_keys_of_lookup {rid : RegionId} {region : Region} {heap : Heap}
...
theorem makeRegion_corollary_objMap_get_eq {cfg cfg' : RuntimeConfig} {x : VarName}
...
theorem makeRegion_corollary_objAt_fresh {cfg cfg' : RuntimeConfig} {x : VarName}
    (h : makeRegion x cfg = some cfg') :
...
-- with it.
theorem makeRegion_corollary_objAt_eq_of_ne_fresh (vcfg : ValidConfig cfg) (vcfg' : ValidConfig cfg')
...
theorem makeRegion_corollary_refStep_source_ne_fresh_cfg' {cfg cfg' : RuntimeConfig} {x : VarName}
...
theorem makeRegion_corollary_frameRoot_down {cfg cfg' : RuntimeConfig} {x : VarName}
