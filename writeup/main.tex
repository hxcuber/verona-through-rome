...
\begin{definition}[Stack-reachable]
  An object or region is stack-reachable if it is frame-reachable from any frame in the stack.
  \begin{mathpar}
    \inferrule*
...
\begin{definition}[Frame-reachable]
  An object or region is frame-reachable if
  \begin{mathpar}
    \inferrule*[lab=var]
...
\begin{definition}[Region-reachable]
  An object or region is region-reachable if
  \begin{mathpar}
    \inferrule*[lab=bridge]
      {H(rid) = (boid, \_, \_)}
